...
void _set_bezier_path_points(Path_t* const path) {
    f32 start_end_diff = path->start_node->pos.x - path->end_node->pos.x;
    ...
    if(path->start_node == path->end_node) {
        ...
        control_p1.x = path->start_node->pos.x + 200.0f;
        control_p1.y = path->start_node->pos.y - 200.0f;

        control_p2.x = path->end_node->pos.x - 200.0f;
        control_p2.y = path->end_node->pos.y - 200.0f;
        ...
        control_p1.x = path->start_node->pos.x - 0.5f * start_end_diff;
        control_p1.y = path->start_node->pos.y + 0.4f * start_end_diff;

        control_p2.x = path->end_node->pos.x + 0.5f * start_end_diff;
        control_p2.y = path->end_node->pos.y + 0.4f * start_end_diff;
